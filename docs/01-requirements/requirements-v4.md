# SignalRisk — Requirements Document v4

> **Revision Note:** Addresses all critical and high issues from AI Review Iteration 3.
> Key additions: End-to-end erasure propagation (model unlearning, backups, derived artifacts),
